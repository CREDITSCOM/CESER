...
(function () {
    function CreateTransaction(Obj) {
        ...
        */
        ...
        //     Hex += ArHex[Math.floor(PerStr[j] % 16)];
        // }
        console.log(ConvertByteToHex(PerStr));
    ...
    function ConvertByteToHex(BytesArray) {
      var ArHex = "0123456789ABCDEF";
      var Hex = "";
      for (let j = 0; j < BytesArray.length; j++) {
          Hex += ArHex[Math.floor(BytesArray[j] / 16)];
          Hex += ArHex[Math.floor(BytesArray[j] % 16)];
      }
    }
...
TransactionType = {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i32 = 0; _i32 < _size30; ++_i32) {
            var elem33 = null;
            elem33 = new DelegatedItem();
            elem33.read(input);
            this.donors.push(elem33);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i36 = 0; _i36 < _size34; ++_i36) {
            var elem37 = null;
            elem37 = new DelegatedItem();
            elem37.read(input);
            this.recipients.push(elem37);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  Delegated.prototype.write = function(output) {
    ...
    if (this.donors !== null && this.donors !== undefined) {
      ...
      for (var iter38 in this.donors) {
        if (this.donors.hasOwnProperty(iter38)) {
          iter38 = this.donors[iter38];
          iter38.write(output);
        }
      }
      output.writeListEnd();
    ...
    if (this.recipients !== null && this.recipients !== undefined) {
      ...
      for (var iter39 in this.recipients) {
        if (this.recipients.hasOwnProperty(iter39)) {
          iter39 = this.recipients[iter39];
          iter39.write(output);
        }
      }
      output.writeListEnd();
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.MAP) {
          ...
          for (var _i42 = 0; _i42 < _size40; ++_i42) {
            ...
            var key43 = null;
            var val44 = null;
            key43 = input.readByte().value;
            val44 = new CumulativeAmount();
            val44.read(input);
            this.balancePerCurrency[key43] = val44;
          }
          input.readMapEnd();
        } else {
          input.skip(ftype);
  ...
  PeriodStats.prototype.write = function(output) {
    ...
    if (this.balancePerCurrency !== null && this.balancePerCurrency !== undefined) {
      ...
      for (var kiter45 in this.balancePerCurrency) {
        if (this.balancePerCurrency.hasOwnProperty(kiter45)) {
          var viter46 = this.balancePerCurrency[kiter45];
          output.writeByte(kiter45);
  ...
  TransactionFlowResult.prototype.write = function(output) {
    ...
    if (this.extraFee !== null && this.extraFee !== undefined) {
      ...
      output.writeListBegin(Thrift.Type.STRUCT, this.extraFee.length);
      for (var iter56 in this.extraFee) {
        if (this.extraFee.hasOwnProperty(iter56)) {
          iter56 = this.extraFee[iter56];
          iter56.write(output);
        }
      }
      output.writeListEnd();
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i59 = 0; _i59 < _size57; ++_i59) {
            var elem60 = null;
            elem60 = new SingleTokenQuery();
            elem60.read(input);
            this.tokensList.push(elem60);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  SingleQuery.prototype.write = function(output) {
    ...
    if (this.tokensList !== null && this.tokensList !== undefined) {
      ...
      for (var iter61 in this.tokensList) {
        if (this.tokensList.hasOwnProperty(iter61)) {
          iter61 = this.tokensList[iter61];
          iter61.write(output);
        }
      }
      output.writeListEnd();
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i64 = 0; _i64 < _size62; ++_i64) {
            var elem65 = null;
            elem65 = new SingleQuery();
            elem65.read(input);
            this.queries.push(elem65);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  TransactionsQuery.prototype.write = function(output) {
    ...
    if (this.queries !== null && this.queries !== undefined) {
      ...
      for (var iter66 in this.queries) {
        if (this.queries.hasOwnProperty(iter66)) {
          iter66 = this.queries[iter66];
          iter66.write(output);
        }
      }
      output.writeListEnd();
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i78 = 0; _i78 < _size76; ++_i78) {
            var elem79 = null;
            elem79 = new SelectedTokenTransfers();
            elem79.read(input);
            this.transfersList.push(elem79);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  PublicKeyTransactions.prototype.write = function(output) {
    ...
    if (this.transactions !== null && this.transactions !== undefined) {
      ...
      output.writeListBegin(Thrift.Type.STRUCT, this.transactions.length);
      for (var iter80 in this.transactions) {
        if (this.transactions.hasOwnProperty(iter80)) {
          iter80 = this.transactions[iter80];
          iter80.write(output);
        }
      }
      output.writeListEnd();
    ...
    if (this.transfersList !== null && this.transfersList !== undefined) {
      ...
      for (var iter81 in this.transfersList) {
        if (this.transfersList.hasOwnProperty(iter81)) {
          iter81 = this.transfersList[iter81];
          iter81.write(output);
        }
      }
      output.writeListEnd();
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i84 = 0; _i84 < _size82; ++_i84) {
            var elem85 = null;
            elem85 = new PublicKeyTransactions();
            elem85.read(input);
            this.queryResponse.push(elem85);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  FilteredTransactionsListResult.prototype.write = function(output) {
    ...
    if (this.queryResponse !== null && this.queryResponse !== undefined) {
      ...
      for (var iter86 in this.queryResponse) {
        if (this.queryResponse.hasOwnProperty(iter86)) {
          iter86 = this.queryResponse[iter86];
          iter86.write(output);
        }
      }
      output.writeListEnd();
  ...
  PoolListGetResult.prototype.write = function(output) {
    ...
    if (this.pools !== null && this.pools !== undefined) {
      ...
      for (var iter91 in this.pools) {
        if (this.pools.hasOwnProperty(iter91)) {
          iter91 = this.pools[iter91];
          iter91.write(output);
        }
      }
      output.writeListEnd();
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i94 = 0; _i94 < _size92; ++_i94) {
            var elem95 = null;
            elem95 = new SealedTransaction();
            elem95.read(input);
            this.transactions.push(elem95);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  PoolTransactionsGetResult.prototype.write = function(output) {
    ...
    if (this.transactions !== null && this.transactions !== undefined) {
      output.writeFieldBegin('transactions', Thrift.Type.LIST, 2);
      output.writeListBegin(Thrift.Type.STRUCT, this.transactions.length);
      for (var iter96 in this.transactions) {
        if (this.transactions.hasOwnProperty(iter96)) {
          iter96 = this.transactions[iter96];
          iter96.write(output);
        }
      }
      output.writeListEnd();
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i99 = 0; _i99 < _size97; ++_i99) {
            var elem100 = null;
            elem100 = new PeriodStats();
            elem100.read(input);
            this.stats.push(elem100);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  StatsGetResult.prototype.write = function(output) {
    ...
    if (this.stats !== null && this.stats !== undefined) {
      ...
      for (var iter101 in this.stats) {
        if (this.stats.hasOwnProperty(iter101)) {
          iter101 = this.stats[iter101];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i104 = 0; _i104 < _size102; ++_i104) {
            var elem105 = null;
            elem105 = input.readBinary().value;
            this.addressesList.push(elem105);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  SmartContractAddressesListGetResult.prototype.write = function(output) {
    ...
    if (this.addressesList !== null && this.addressesList !== undefined) {
      ...
      for (var iter106 in this.addressesList) {
        if (this.addressesList.hasOwnProperty(iter106)) {
          iter106 = this.addressesList[iter106];
          output.writeBinary(iter106);
        }
      }
      output.writeListEnd();
      output.writeFieldEnd();
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i109 = 0; _i109 < _size107; ++_i109) {
            var elem110 = null;
            elem110 = new SmartContract();
            elem110.read(input);
            this.smartContractsList.push(elem110);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  SmartContractsListGetResult.prototype.write = function(output) {
    ...
    if (this.smartContractsList !== null && this.smartContractsList !== undefined) {
      ...
      for (var iter111 in this.smartContractsList) {
        if (this.smartContractsList.hasOwnProperty(iter111)) {
          iter111 = this.smartContractsList[iter111];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.MAP) {
          ...
          for (var _i114 = 0; _i114 < _size112; ++_i114) {
            ...
            var key115 = null;
            var val116 = null;
            key115 = input.readI64().value;
            val116 = input.readI32().value;
            this.states[key115] = val116;
          }
          input.readMapEnd();
        } else {
          input.skip(ftype);
  ...
  TransactionsStateGetResult.prototype.write = function(output) {
    ...
    if (this.states !== null && this.states !== undefined) {
      ...
      for (var kiter117 in this.states) {
        if (this.states.hasOwnProperty(kiter117)) {
          var viter118 = this.states[kiter117];
          output.writeI64(kiter117);
          output.writeI32(viter118);
        }
      }
      output.writeMapEnd();
      output.writeFieldEnd();
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i126 = 0; _i126 < _size124; ++_i126) {
            var elem127 = null;
            elem127 = new MethodDescription();
            elem127.read(input);
            this.methods.push(elem127);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  ContractAllMethodsGetResult.prototype.write = function(output) {
    ...
    if (this.methods !== null && this.methods !== undefined) {
      ...
      for (var iter128 in this.methods) {
        if (this.methods.hasOwnProperty(iter128)) {
          iter128 = this.methods[iter128];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i131 = 0; _i131 < _size129; ++_i131) {
            var elem132 = null;
            elem132 = new SmartContractMethodArgument();
            elem132.read(input);
            this.arguments.push(elem132);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  SmartContractMethod.prototype.write = function(output) {
    ...
    if (this.arguments !== null && this.arguments !== undefined) {
      output.writeFieldBegin('arguments', Thrift.Type.LIST, 3);
      output.writeListBegin(Thrift.Type.STRUCT, this.arguments.length);
      for (var iter133 in this.arguments) {
        if (this.arguments.hasOwnProperty(iter133)) {
          iter133 = this.arguments[iter133];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i136 = 0; _i136 < _size134; ++_i136) {
            var elem137 = null;
            elem137 = new SmartContractMethod();
            elem137.read(input);
            this.methods.push(elem137);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  SmartContractDataResult.prototype.write = function(output) {
    ...
    if (this.methods !== null && this.methods !== undefined) {
      ...
      output.writeListBegin(Thrift.Type.STRUCT, this.methods.length);
      for (var iter143 in this.methods) {
        if (this.methods.hasOwnProperty(iter143)) {
          iter143 = this.methods[iter143];
    ...
    if (this.variables !== null && this.variables !== undefined) {
      ...
      for (var kiter144 in this.variables) {
        if (this.variables.hasOwnProperty(kiter144)) {
          var viter145 = this.variables[kiter144];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i148 = 0; _i148 < _size146; ++_i148) {
            var elem149 = null;
            elem149 = new ByteCodeObject();
            elem149.read(input);
            this.byteCodeObjects.push(elem149);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  SmartContractCompileResult.prototype.write = function(output) {
    ...
    if (this.byteCodeObjects !== null && this.byteCodeObjects !== undefined) {
      output.writeFieldBegin('byteCodeObjects', Thrift.Type.LIST, 2);
      output.writeListBegin(Thrift.Type.STRUCT, this.byteCodeObjects.length);
      for (var iter150 in this.byteCodeObjects) {
        if (this.byteCodeObjects.hasOwnProperty(iter150)) {
          iter150 = this.byteCodeObjects[iter150];
  ...
  TokenTransaction.prototype.write = function(output) {
    ...
    if (this.params !== null && this.params !== undefined) {
      ...
      output.writeListBegin(Thrift.Type.STRUCT, this.params.length);
      for (var iter155 in this.params) {
        if (this.params.hasOwnProperty(iter155)) {
          iter155 = this.params[iter155];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i158 = 0; _i158 < _size156; ++_i158) {
            var elem159 = null;
            elem159 = new TokenBalance();
            elem159.read(input);
            this.balances.push(elem159);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  TokenBalancesResult.prototype.write = function(output) {
    ...
    if (this.balances !== null && this.balances !== undefined) {
      ...
      for (var iter160 in this.balances) {
        if (this.balances.hasOwnProperty(iter160)) {
          iter160 = this.balances[iter160];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i163 = 0; _i163 < _size161; ++_i163) {
            var elem164 = null;
            elem164 = new ExtraFee();
            elem164.read(input);
            this.extraFee.push(elem164);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  TokenTransfer.prototype.write = function(output) {
    ...
    if (this.extraFee !== null && this.extraFee !== undefined) {
      output.writeFieldBegin('extraFee', Thrift.Type.LIST, 14);
      output.writeListBegin(Thrift.Type.STRUCT, this.extraFee.length);
      for (var iter165 in this.extraFee) {
        if (this.extraFee.hasOwnProperty(iter165)) {
          iter165 = this.extraFee[iter165];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i168 = 0; _i168 < _size166; ++_i168) {
            var elem169 = null;
            elem169 = new TokenTransfer();
            elem169.read(input);
            this.transfers.push(elem169);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  TokenTransfersResult.prototype.write = function(output) {
    ...
    if (this.transfers !== null && this.transfers !== undefined) {
      ...
      output.writeListBegin(Thrift.Type.STRUCT, this.transfers.length);
      for (var iter170 in this.transfers) {
        if (this.transfers.hasOwnProperty(iter170)) {
          iter170 = this.transfers[iter170];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i173 = 0; _i173 < _size171; ++_i173) {
            var elem174 = null;
            elem174 = new TokenTransaction();
            elem174.read(input);
            this.transactions.push(elem174);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  TokenTransactionsResult.prototype.write = function(output) {
    ...
    if (this.transactions !== null && this.transactions !== undefined) {
      ...
      output.writeListBegin(Thrift.Type.STRUCT, this.transactions.length);
      for (var iter175 in this.transactions) {
        if (this.transactions.hasOwnProperty(iter175)) {
          iter175 = this.transactions[iter175];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i178 = 0; _i178 < _size176; ++_i178) {
            var elem179 = null;
            elem179 = new TokenHolder();
            elem179.read(input);
            this.holders.push(elem179);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  TokenHoldersResult.prototype.write = function(output) {
    ...
    if (this.holders !== null && this.holders !== undefined) {
      ...
      for (var iter180 in this.holders) {
        if (this.holders.hasOwnProperty(iter180)) {
          iter180 = this.holders[iter180];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i183 = 0; _i183 < _size181; ++_i183) {
            var elem184 = null;
            elem184 = new TokenInfo();
            elem184.read(input);
            this.tokens.push(elem184);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  TokensListResult.prototype.write = function(output) {
    ...
    if (this.tokens !== null && this.tokens !== undefined) {
      ...
      for (var iter185 in this.tokens) {
        if (this.tokens.hasOwnProperty(iter185)) {
          iter185 = this.tokens[iter185];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i188 = 0; _i188 < _size186; ++_i188) {
            var elem189 = null;
            elem189 = new WalletInfo();
            elem189.read(input);
            this.wallets.push(elem189);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  WalletsGetResult.prototype.write = function(output) {
    ...
    if (this.wallets !== null && this.wallets !== undefined) {
      ...
      for (var iter190 in this.wallets) {
        if (this.wallets.hasOwnProperty(iter190)) {
          iter190 = this.wallets[iter190];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i193 = 0; _i193 < _size191; ++_i193) {
            var elem194 = null;
            elem194 = new TrustedInfo();
            elem194.read(input);
            this.writers.push(elem194);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  TrustedGetResult.prototype.write = function(output) {
    ...
    if (this.writers !== null && this.writers !== undefined) {
      ...
      for (var iter195 in this.writers) {
        if (this.writers.hasOwnProperty(iter195)) {
          iter195 = this.writers[iter195];
...
API_ActualFeeGet_args = function(args) {
  ...
  API_ActualFeeGet_args.prototype = {};
  API_ActualFeeGet_args.prototype.read = function(input) {
    input.readStructBegin();
    while (true) {
      var ret = input.readFieldBegin();
      var ftype = ret.ftype;
      ...
      switch (fid) {
        case 1:
        if (ftype == Thrift.Type.I32) {
          this.transactionSize = input.readI32().value;
        } else {
          input.skip(ftype);
        }
        break;
  ...
  API_ActualFeeGet_args.prototype.write = function(output) {
  ...
  API_ActualFeeGet_result = function(args) {
    this.success = null;
    if (args) {
      if (args.success !== undefined && args.success !== null) {
        this.success = new ActualFeeGetResult(args.success);
      }
    }
  };
  API_ActualFeeGet_result.prototype = {};
  API_ActualFeeGet_result.prototype.read = function(input) {
    input.readStructBegin();
    while (true) {
      var ret = input.readFieldBegin();
      var ftype = ret.ftype;
      ...
      switch (fid) {
        case 0:
        if (ftype == Thrift.Type.STRUCT) {
          this.success = new ActualFeeGetResult();
  ...
  API_ActualFeeGet_result.prototype.write = function(output) {
  ...
  API_FilteredTransactionsListGet_args = function(args) {
    this.generalQuery = null;
    if (args) {
      if (args.generalQuery !== undefined && args.generalQuery !== null) {
        this.generalQuery = new TransactionsQuery(args.generalQuery);
      }
    }
  };
  API_FilteredTransactionsListGet_args.prototype = {};
  API_FilteredTransactionsListGet_args.prototype.read = function(input) {
    input.readStructBegin();
    while (true) {
      var ret = input.readFieldBegin();
      var ftype = ret.ftype;
      ...
      switch (fid) {
        case 1:
        if (ftype == Thrift.Type.STRUCT) {
          this.generalQuery = new TransactionsQuery();
  ...
  API_FilteredTransactionsListGet_args.prototype.write = function(output) {
  ...
  API_FilteredTransactionsListGet_result = function(args) {
    this.success = null;
    if (args) {
      if (args.success !== undefined && args.success !== null) {
        this.success = new FilteredTransactionsListResult(args.success);
      }
    }
  };
  API_FilteredTransactionsListGet_result.prototype = {};
  API_FilteredTransactionsListGet_result.prototype.read = function(input) {
    input.readStructBegin();
    while (true) {
      var ret = input.readFieldBegin();
      var ftype = ret.ftype;
      ...
      switch (fid) {
        case 0:
        if (ftype == Thrift.Type.STRUCT) {
          this.success = new FilteredTransactionsListResult();
          this.success.read(input);
        } else {
          input.skip(ftype);
        }
  ...
  API_FilteredTransactionsListGet_result.prototype.write = function(output) {
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i198 = 0; _i198 < _size196; ++_i198) {
            var elem199 = null;
            elem199 = input.readI64().value;
            this.id.push(elem199);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  API_TransactionsStateGet_args.prototype.write = function(output) {
    ...
    if (this.id !== null && this.id !== undefined) {
      ...
      for (var iter200 in this.id) {
        if (this.id.hasOwnProperty(iter200)) {
          iter200 = this.id[iter200];
      ...
      switch (fid) {
        ...
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i203 = 0; _i203 < _size201; ++_i203) {
            var elem204 = null;
            elem204 = new ByteCodeObject();
            elem204.read(input);
            this.byteCodeObjects.push(elem204);
          }
          input.readListEnd();
        } else {
          input.skip(ftype);
  ...
  API_ContractAllMethodsGet_args.prototype.write = function(output) {
    ...
    if (this.byteCodeObjects !== null && this.byteCodeObjects !== undefined) {
      output.writeFieldBegin('byteCodeObjects', Thrift.Type.LIST, 1);
      output.writeListBegin(Thrift.Type.STRUCT, this.byteCodeObjects.length);
      for (var iter205 in this.byteCodeObjects) {
        if (this.byteCodeObjects.hasOwnProperty(iter205)) {
          iter205 = this.byteCodeObjects[iter205];
  ...
  APIClient.prototype.ActualFeeGet = function(transactionSize, callback) {
    this.send_ActualFeeGet(transactionSize, callback); 
    if (!callback) {
      return this.recv_ActualFeeGet();
    }
  };
  
  APIClient.prototype.send_ActualFeeGet = function(transactionSize, callback) {
    var params = {
      transactionSize: transactionSize
    };
    var args = new API_ActualFeeGet_args(params);
    try {
      this.output.writeMessageBegin('ActualFeeGet', Thrift.MessageType.CALL, this.seqid);
  ...
  APIClient.prototype.recv_ActualFeeGet = function() {
    ...
    var result = new API_ActualFeeGet_result();
    ...
    throw 'ActualFeeGet failed: unknown result';
  };
  ...
  APIClient.prototype.FilteredTransactionsListGet = function(generalQuery, callback) {
    this.send_FilteredTransactionsListGet(generalQuery, callback); 
    if (!callback) {
      return this.recv_FilteredTransactionsListGet();
    }
  };
  
  APIClient.prototype.send_FilteredTransactionsListGet = function(generalQuery, callback) {
    var params = {
      generalQuery: generalQuery
    };
    var args = new API_FilteredTransactionsListGet_args(params);
    try {
      this.output.writeMessageBegin('FilteredTransactionsListGet', Thrift.MessageType.CALL, this.seqid);
      args.write(this.output);
      this.output.writeMessageEnd();
      if (callback) {
        var self = this;
        this.output.getTransport().flush(true, function() {
          var result = null;
          try {
            result = self.recv_FilteredTransactionsListGet();
          } catch (e) {
            result = e;
          }
          callback(result);
  ...
  APIClient.prototype.recv_FilteredTransactionsListGet = function() {
    var ret = this.input.readMessageBegin();
    var mtype = ret.mtype;
    if (mtype == Thrift.MessageType.EXCEPTION) {
      var x = new Thrift.TApplicationException();
    ...
    var result = new API_FilteredTransactionsListGet_result();
    result.read(this.input);
    this.input.readMessageEnd();
    ...
    throw 'FilteredTransactionsListGet failed: unknown result';
  };
